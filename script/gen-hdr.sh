...
# Generate the final header.
{
    ...
    cat << EOF
/**
 * This header is generated by $0. Do not edit this file directly.
 *
 * <h3>Useful preprocessor options for users of this header:</h3>
 * <p><i>CLANGDB_VISIBILITY</i> - controls the visibility of symbols declared in this header. By default, it is empty, which means the symbols will have default visibility. You can set it to 
 *   "default" to explicitly specify default visibility, or "hidden" to hide the symbols.
 *    <b>Default Value</b>: "default" </p>
 */
EOF
} > "$sys_header"
